      ...
      <el-table :data="tableData" border class="table" ref="multipleTable"
        ...
        <el-table-column label="操作" width="180" align="center">
          <template slot-scope="scope">
            ...
            <el-button type="text" @click="openPwd(scope.$index, scope.row)">
              重置密码
            </el-button>
            <el-button type="text" class="red" @click="handleDelete(scope.$index, scope.row)">
              禁用
            </el-button>
            <!--<el-popover placement="bottom" width="30" v-model="optionVisible">-->
            <!--<el-button type="text" @click="handleEdit(scope.$index, scope.row)">-->
            <!--编辑-->
            <!--</el-button>-->
            <!--<el-button type="text" @click="handleEdit(scope.$index, scope.row)">-->
            ...
            <!--&gt;删除-->
            <!--</el-button>-->
            <!--<el-button type="text" slot="reference">更多操作<i class="el-icon-download"></i></el-button>-->
            <!--</el-popover>-->
          </template>
        </el-table-column>
      </el-table>
...
<script>
  ...
  export default {
    ...
    methods: {
      getData() {
        httpPost('user/list', this.query).then((res) => {
          if (res.code == 0) {
