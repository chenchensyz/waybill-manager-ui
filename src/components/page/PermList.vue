      ...
      <el-table :data="tableData" style="width: 100%;margin-bottom: 20px;"
        ...
        <el-table-column label="操作" width="180" align="center">
          <template slot-scope="scope">
            ...
            <el-button type="text" @click="permEdit(scope.$index, scope.row)">子菜单</el-button>
    ...
    <el-dialog :title=dialogFormTitle :visible.sync="editVisible" width="50%">
      <el-form ref="form" :model="form" label-width="150px" :rules="fieldRules">
        ...
        <el-form-item label="描述" prop="introduction">
          <el-input label="描述" v-model="form.remark" type="textarea" :rows="4"></el-input>
        </el-form-item>
      </el-form>
...
<script>
  ...
  export default {
    ...
    methods: {
      getData() {
        httpPost('permission/userPerms', this.query).then((res) => {
          if (res.code == 0) {
